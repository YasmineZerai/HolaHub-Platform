...
export default function AddedPost(){
    ...
    const addPost=(event)=>{event.preventDefault(); posts.setPosts((prev)=>[...prev, {
        "id": prev.length,
        "body": newPost,
        "userId": user.id,
        "reactions": 0,
...
<form onSubmit={addPost}>
   <div class="w-full mb-4 border rounded-lg bg-lightOrange ">
       ...
       <div class="px-4 py-2 bg-lightOrange rounded-b-lg">
           <label for="editor" class="sr-only">Publish post</label>
           <textarea onChange={(event)=>{setNewPost(event.target.value)}} id="editor" rows="8" class="block w-full p-5 text-sm bg-subtle" placeholder="Write a post..." required></textarea>
       </div>
   </div>
   <button type="submit" class="rounded-md inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-peachy">
       Publish post
   </button>
</form>
